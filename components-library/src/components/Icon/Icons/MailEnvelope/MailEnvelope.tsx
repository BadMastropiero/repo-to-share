...
const MailEnvelope: React.FC<CustomIconProps> = ({
  primary,
  customColor: color,
  disabled,
  width = '24px',
  ...
  <IconBase
    className="ticons-mail_envelope"
    primary={primary}
    color={color}
    disabled={disabled}
    height={height} // "24px"
