...
import { breakpoints, halfBreakpoints, minimumPaddings, minimumPaddingsVerticals, halfBreakpointsVerticals, devices, } from '../../styles/breakpoints';
...
const dynamicPadding = (fixedPaddingLeft, fixedPaddingRight) => {
    const dynamicPaddingSize = (size) => `calc(50vw - ${halfBreakpoints[size]})`;
    return css `
...
const dynamicPaddingVertical = (fixedPaddingTop, fixedPaddingBottom) => {
    const dynamicPaddingSize = (size) => `calc(50vh - ${halfBreakpointsVerticals[size]})`;
    return css `
    ...
    ${respondAbove('tablet', {
        ...
        paddingBottom: `calc(max(${dynamicPaddingSize('tablet')}, ${minimumPaddingsVerticals.tablet}))`,
    })}
    ${respondAbove('laptop', {
        paddingTop: `calc(max(${dynamicPaddingSize('laptop')}, ${minimumPaddingsVerticals.laptop}))`,
        paddingBottom: `calc(max(${dynamicPaddingSize('laptop')}, ${minimumPaddingsVerticals.laptop}))`,
    })}
    ${respondAbove('laptopL', {
        paddingTop: `calc(max(${dynamicPaddingSize('laptopL')}, ${minimumPaddingsVerticals.laptopL}))`,
        paddingBottom: `calc(max(${dynamicPaddingSize('laptopL')}, ${minimumPaddingsVerticals.laptopL}))`,
    })}
    ${respondAbove('desktop', {
        paddingTop: `calc(max(${dynamicPaddingSize('desktop')}, ${minimumPaddingsVerticals.desktop}))`,
        paddingBottom: `calc(max(${dynamicPaddingSize('desktop')}, ${minimumPaddingsVerticals.desktop}))`,
    })}
  `;
};
const gridAlignment = () => css `
  ...
  place-items: center;
`;
const dynamicBackground = (background, clipPath) => css `
