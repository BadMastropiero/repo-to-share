...
const StyledBookmark = styled(DynamicComponent)(({ theme: { colors: { primary600, primaryBg }, transition, }, primary: isPrimary, }) => css `
    color: unset;
  ...
  `);
const BmIconContainer = styled.div(({ theme: { colors: { primary: primaryColor, primary100 }, transition, }, primary: isPrimary, }) => css `
    display: flex;
    flex-direction: row;
