...
const StyledAlert = styled(Modal)(({ theme: { colors: { primary: primaryColor, primaryBg, primary100, primary600 }, }, primary: isPrimary, }) => css `
...
export const AlertHeader = styled.div `
  ...
  align-items: center;
`;
export const AlertCloseButton = styled(Button)(({ theme: { colors: { primaryLight, primaryBg }, }, primary: isPrimary, }) => css `
    border: unset;
