...
export const StyledIconContainer = styled.div(({ theme: { colors: { primary100, primaryDark }, }, primary: isPrimary, padding, }) => css `
    transition: all 0.3s;
    display: flex;
    flex-direction: row;
    ...
    padding: ${padding};
  `);
export const StyledButton = styled(DynamicComponent)(({ theme: { colors: { primary, primaryDark, primary50, primary100, primary200, primary600, primary800, primaryBg, }, transition, }, primary: isPrimary, rounded, }) => css `
  ...
  `);
export const StyledTextButton = styled(StyledButton)(({ theme: { colors: { primaryDark, primary100 }, }, primary: isPrimary, }) => css `
