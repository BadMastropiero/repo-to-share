...
const OptionContainer = styled.div(({ theme: { colors: { primary: primaryColor, primary50, primary600, primaryBg }, transition, }, primary: isPrimary, noCheckbox, disabled, }) => css `
    position: relative;
    left: 0;
    top: 0;
    fill: none;
