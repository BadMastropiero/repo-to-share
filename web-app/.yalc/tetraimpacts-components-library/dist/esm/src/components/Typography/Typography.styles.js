...
export const StyledTypography = styled(DynamicComponent)(({ theme: { typography: { base: { fontFamily, margin, padding, colors, color, lineHeight, fontSize, fontStyle, fontWeight, textAlign, textTransform, letterSpacing, textDecorationLine, gradient, }, }, }, margin: customMargin, padding: customPadding, lineNumbers, }) => css `
