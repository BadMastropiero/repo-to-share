...
const stories = __importStar(require("./DynamicComponent.stories"));
// Every component that is returned maps 1:1 with the stories, but they already contain all decorators from story level, meta level and global level!
const { Base } = (0, testing_react_1.composeStories)(stories);
describe('DynamicComponent tests', () => {
    test('should render', () => {
        const component = (0, react_1.render)((0, jsx_runtime_1.jsx)(Base, {}));
    ...
    test('should render correct tag type', () => {
        const { container } = (0, react_1.render)((0, jsx_runtime_1.jsx)(Base, { tag: "h2" }));
        expect(container.querySelector('h2')).toBeInTheDocument();
    });
});
//# sourceMappingURL=DynamicComponent.test.js.map