...
const stories = __importStar(require("./Card.stories"));
...
describe('Card tests', () => {
    ...
    it('should trigger on click', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const tree = (0, react_1.render)((0, jsx_runtime_1.jsx)(Base, { onClick: mockCallBack }));
        const card = yield tree.findByText('Shape your ideas');
        user_event_1.default.click(card);
