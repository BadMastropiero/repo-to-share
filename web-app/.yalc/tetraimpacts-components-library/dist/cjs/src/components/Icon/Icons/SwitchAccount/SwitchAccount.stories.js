...
const SwitchAccount_1 = __importDefault(require("./SwitchAccount"));
exports.default = {
    title: 'Icons/SwitchAccount',
    component: SwitchAccount_1.default,
};
const Base = args => {
    const { primary, customColor: color, disabled, height, width } = args;
    return ((0, jsx_runtime_1.jsx)(SwitchAccount_1.default, { primary: primary, customColor: color, disabled: disabled, height: height, width: width }));
};
exports.Base = Base;
exports.Base.args = {
    primary: true,
