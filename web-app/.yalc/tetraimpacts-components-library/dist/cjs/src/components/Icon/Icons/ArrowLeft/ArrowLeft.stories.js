...
exports.default = {
    ...
    component: ArrowLeft_1.default,
};
const Base = args => {
    const { primary, disabled, height, width } = args, rest = __rest(args, ["primary", "disabled", "height", "width"]);
    return ((0, jsx_runtime_1.jsx)(ArrowLeft_1.default, Object.assign({ primary: primary, disabled: disabled, height: height, width: width }, rest)));
};
exports.Base = Base;
exports.Base.args = {
    primary: true,
...
//# sourceMappingURL=ArrowLeft.stories.js.map