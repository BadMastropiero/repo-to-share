...
const MailSend_1 = __importDefault(require("./MailSend"));
exports.default = {
    title: 'Icons/MailSend',
    component: MailSend_1.default,
};
const Base = args => {
    const { primary, customColor: color, disabled, height, width } = args;
    return ((0, jsx_runtime_1.jsx)(MailSend_1.default, { primary: primary, customColor: color, disabled: disabled, height: height, width: width }));
};
exports.Base = Base;
exports.Base.args = {
    primary: true,
