...
const ArrowUp_1 = __importDefault(require("./ArrowUp"));
exports.default = {
    title: 'Icons/ArrowUp',
    component: ArrowUp_1.default,
};
const Base = args => {
    const { primary, customColor: color, disabled, height, width } = args;
    return ((0, jsx_runtime_1.jsx)(ArrowUp_1.default, { primary: primary, customColor: color, disabled: disabled, height: height, width: width }));
};
exports.Base = Base;
exports.Base.args = {
    primary: true,
