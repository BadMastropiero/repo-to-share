// WARN copied almost verbatim from https://github.com/ejrbuss/markdown-to-txt
 ...
 */
export function markdownToTxt(markdown: string, options?: marked.MarkedOptions): string {
